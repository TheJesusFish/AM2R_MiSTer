...
| [MiSTer-CRT-Adjust](https://github.com/rmonic79/MiSTer-CRT-Adjust) | Core-side H-Size, H-Position, V-Shift and experimental PVM/Cabinet V-Size; adopted at commit `c682de9f4acc61d8f4c7779efb48149d3baa3a8e` | GPL-3.0-or-later; vendored modules are unchanged except repository line-ending normalization, `sys/` remains untouched, and the enabled adjustment reaches HDMI too |
