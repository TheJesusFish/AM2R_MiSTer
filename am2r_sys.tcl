...
# Core-local manifest substitutes an explicit M10K-backed OSD implementation.
# Keep it as a QIP assignment, matching the framework's normal import path;
# sourcing the manifest directly changes Quartus 17's RAM-inference behaviour
# for unrelated VHDL memories in ASCal. The upstream sys directory remains
# unmodified.
set_global_assignment -name QIP_FILE am2r_sys.qip
